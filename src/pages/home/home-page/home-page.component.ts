...
export class HomePageComponent implements OnInit {
  ...
  getScores(){
     this.scores = [
      ...
      {name:"Eava",grade:"一年一班",Englishscore:97,Mathscore:80,random:Math.random()},
      {name:"Vender",grade:"一年一班",Englishscore:99,Mathscore:94,random:Math.random()},
      {name:"Lucy",grade:"一年一班",Englishscore:99,Mathscore:99,random:Math.random()}
    ]
